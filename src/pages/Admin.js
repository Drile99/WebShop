        ...
        <div className="row align-items-center">
          <div className="col-md-10 mx-auto">
            ...
            <form onSubmit={addFormSubmit}>
              ...
              <input value={qty} onChange={(event)=>setQty(event.target.value)} className='m-2' type="number" placeholder="Quantity"/>
              ...
              <select value={img} onChange={(event)=>setImg(event.target.value)} className='m-2'>
                <option value='img/product1.jpg'>Orange T-shirt</option>
                <option value='img/product2.jpg'>Traveller Bag</option>
                <option value='img/product3.jpg'>Sunglasses</option>
                <option value='img/product4.jpg'>Smart Watch</option>
                <option value='img/product5.jpg'>Hat</option>
                <option value='img/product6.jpg'>Roller Skates</option>
              </select>
